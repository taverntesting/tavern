...
class YamlFile(pytest.File):
    ...
    def get_parametrized_items(self, test_spec, parametrize_mark, pytest_marks):
        ...
        """
        key = parametrize_mark["key"]
        vals = parametrize_mark["vals"]
    ...
    def collect(self):
        ...
        for test_spec in all_tests:
            ...
            if marks:
                ...
                try:
                    parametrize_mark = next(i for i in marks if isinstance(i, dict) and next(iter(i.keys())) == "parametrize")
