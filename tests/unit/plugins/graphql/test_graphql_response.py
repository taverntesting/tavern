...
class TestGraphQLResponse:
    def test_init_defaults(self):
        ...
        response = GraphQLResponse(session, "test", expected, test_block_config)
    ...
    def test_init_list_status_code(self):
        session = Mock()
    ...
    def test_str_without_response(self):
        session = Mock()
        expected = {}
        test_block_config = TestConfig(
            variables={},
    ...
    def test_validate_response_format_valid_data(self):
        session = Mock()
        expected = {}
        test_block_config = TestConfig(
            variables={},
    ...
    def test_validate_response_format_valid_errors(self):
        session = Mock()
        expected = {}
        test_block_config = TestConfig(
            variables={},
    ...
    def test_validate_response_format_invalid_no_data_or_errors(self):
        session = Mock()
        expected = {}
        test_block_config = TestConfig(
            variables={},
    ...
    def test_verify_status_code_single_match(self):
        session = Mock()
    ...
    def test_verify_status_code_single_mismatch(self):
        session = Mock()
        expected = {"status_code": 200}
        test_block_config = TestConfig(
            variables={},
    ...
    def test_verify_status_code_list_match(self):
        session = Mock()
        expected = {"status_code": [200, 201]}
        test_block_config = TestConfig(
            variables={},
    ...
    def test_verify_status_code_list_mismatch(self):
        session = Mock()
        expected = {"status_code": [200, 201]}
        test_block_config = TestConfig(
            variables={},
